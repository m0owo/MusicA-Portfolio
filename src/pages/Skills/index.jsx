    ...
    return (
        <div className="h-screen w-screen">
            <div className="bg-[url('./assets/BG.png')] bg-cover bg-fixed bg-repeat-y">
                ...
                <div className="sm:mx-20 justify-items-center justify-center m-[15px] grid grid-cols-2 sm:grid-cols-4 gap-y-5 max-w-3xl">
...
const SkillCard = ({pic, text}) => {
    return (
        <div className="flex flex-col justify-center w-[120px] h-[100px] bg-indigo-100 rounded-xl 
